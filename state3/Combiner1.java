...
public class Combiner1 extends Reducer<Text, LongWritable, Text, LongWritable> {
	...
	protected void cleanup(Context context)
		...
		context.write(new Text("file"+n+"#Max"), new LongWritable(Max));
		context.write(new Text("file"+n+"#Min"), new LongWritable(Min));
		context.write(new Text("file"+n+"#Sum"), new LongWritable(Sum));
		context.write(new Text("file"+n+"#Aver"), new LongWritable(Aver/counter1));
